...
.PHONY: all help build install test test-v cover cover-text vet fmt clean check doc audit-readme

all: fmt vet test audit-readme build ## Format, vet, test, audit README, and build the binary
...
check: fmt vet test audit-readme ## Run formatting, vet, tests, and audit README sync (pre-commit check)
